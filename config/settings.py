...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='telegram_parser_db'),
        'USER': config('DB_USER', default='telegram_parser_user'),
...
# WhiteNoise configuration для эффективной раздачи статики
