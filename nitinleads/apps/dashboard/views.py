...
def settings(request):
    ...
    if request.method == 'POST':
        ...
        user.telegram_bot_token = request.POST.get('bot_token', user.telegram_bot_token)
        user.notification_chat_id = request.POST.get('notification_chat_id', user.notification_chat_id)
